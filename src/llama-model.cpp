...
bool llama_model::load_tensors(llama_model_loader & ml) {
    ...
    // create tensors for the weights
    {
        ...
        auto create_tensor_qkv = [&](llama_layer & layer, int bid,
            ...
            if (layer.wqkv) {
                if (has_bias) {
                    layer.bqkv = create_tensor(tn(LLM_TENSOR_ATTN_QKV, "bias", bid), {n_embd_qkv}, TENSOR_NOT_REQUIRED);
                }
            } else {
            ...
            case LLM_ARCH_LLAMA_EMBED:
                {
                    ...
                    for (int i = 0; i < n_layer; ++i) {
                        ...
                        create_tensor_qkv(layer, i, n_embd, n_embd_head_k * n_head, n_embd_k_gqa, n_embd_v_gqa, /*has_bias=*/false, 0);
            ...
            case LLM_ARCH_LLADA_MOE:
                {
                    ...
                    for (int i = 0; i < n_layer; ++i) {
                        ...
                        create_tensor_qkv(layer, i, n_embd, n_embd, n_embd_gqa, n_embd_gqa, /*has_bias=*/false, 0);
            ...
            case LLM_ARCH_STARCODER:
                {
                    ...
                    for (int i = 0; i < n_layer; ++i) {
                        ...
                        create_tensor_qkv(layer, i, n_embd, n_embd, n_embd_gqa, n_embd_gqa, /*has_bias=*/true, 0);
            ...
            case LLM_ARCH_QWEN:
                {
                    ...
                    for (int i = 0; i < n_layer; ++i) {
                        ...
                        create_tensor_qkv(layer, i, n_embd, n_embd, n_embd, n_embd, /*has_bias=*/true, 0);
                        layer.wo   = create_tensor(tn(LLM_TENSOR_ATTN_OUT, "weight", i), {n_embd, n_embd}, 0);
            ...
            case LLM_ARCH_QWEN3VL:
                {
                    ...
                    for (int i = 0; i < n_layer; ++i) {
                        ...
                        create_tensor_qkv(layer, i, n_embd, n_embd_head_k * n_head, n_embd_gqa, n_embd_gqa, /*has_bias=*/false, 0);
                        layer.wo = create_tensor(tn(LLM_TENSOR_ATTN_OUT, "weight", i), {n_embd_head_k * n_head, n_embd}, 0);
            ...
            case LLM_ARCH_PHI3:
                {
                    ...
                    for (int i = 0; i < n_layer; ++i) {
                        ...
                        create_tensor_qkv(layer, i, n_embd, n_embd, n_embd_gqa, n_embd_gqa, /*has_bias=*/false, TENSOR_NOT_REQUIRED);
                        layer.wo   = create_tensor(tn(LLM_TENSOR_ATTN_OUT, "weight", i), { n_embd, n_embd }, 0);
            ...
            case LLM_ARCH_GRANITE_HYBRID:
                {
                    ...
                    for (int i = 0; i < n_layer; ++i) {
                        ...
                        if (hparams.is_recurrent(i)) {
                            ...
                            create_tensor_qkv(layer, i, n_embd, n_embd_head_k * n_head_i, n_embd_k_gqa_i, n_embd_v_gqa_i, /*has_bias=*/false, 0);
            ...
            case LLM_ARCH_SEED_OSS:
                {
                    ...
                    for (int i = 0; i < n_layer; ++i) {
                        ...
                        create_tensor_qkv(layer, i, n_embd, n_qo_dim, n_kv_dim, n_kv_dim, /*has_bias=*/false, 0);
            ...
            case LLM_ARCH_CHATGLM:
                {
                    ...
                    for (int i = 0; i < n_layer; ++i) {
                        ...
                        if (layer.wqkv == nullptr) {
                            create_tensor_qkv(layer, i, n_embd, n_embd_head_k * n_head, n_embd_k_gqa, n_embd_v_gqa, /*has_bias=*/true, 0);
                        }
            ...
            case LLM_ARCH_GLM4:
                {
                    ...
                    for (int i = 0; i < n_layer; ++i) {
                        ...
                        if (layer.wqkv == nullptr) {
                            create_tensor_qkv(layer, i, n_embd, n_embd_head_k * n_head, n_embd_k_gqa, n_embd_v_gqa, /*has_bias=*/true, flags);
                        }
            ...
            case LLM_ARCH_EXAONE_MOE:
                {
                    ...
                    for (int i = 0; i < n_layer; ++i) {
                        ...
                        auto & layer = layers[i];
                        create_tensor_qkv(layer, i, n_embd, n_qo_dim, n_kv_dim, n_kv_dim, /*has_bias=*/false, flags);
            ...
            case LLM_ARCH_BAILINGMOE:
                {
                    ...
                    for (int i = 0; i < n_layer; ++i) {
                        ...
                        create_tensor_qkv(layer, i, n_embd, n_head * n_rot, n_head_kv * n_rot, n_head_kv * n_rot, /*has_bias=*/false, 0);
            ...
            case LLM_ARCH_BAILINGMOE2:
                {
                    ...
                    for (int i = 0; i < n_layer; ++i) {
                        ...
                        create_tensor_qkv(layer, i, n_embd, n_embd, n_embd_gqa, n_embd_gqa, /*has_bias=*/false, flags);
                        layer.wo = create_tensor(tn(LLM_TENSOR_ATTN_OUT, "weight", i), {n_embd_head_k * n_head, n_embd}, flags);
            ...
            case LLM_ARCH_DOTS1:
                {
                    ...
                    for (int i = 0; i < n_layer; ++i) {
                        ...
                        create_tensor_qkv(layer, i, n_embd, n_embd_head_k * n_head, n_embd_head_k * n_head, n_embd_head_k * n_head, /*has_bias=*/false, 0);
                        layer.wo = create_tensor(tn(LLM_TENSOR_ATTN_OUT, "weight", i), {n_embd_head_k * n_head, n_embd}, 0);
            ...
            case LLM_ARCH_FALCON_H1:
                {
                    ...
                    for (int i = 0; i < n_layer; ++i) {
                        ...
                        /*ATTENTION LAYERS*/
                        // attention layers (with optional bias)
                        create_tensor_qkv(layer, i, hidden_size, n_embd_head_k * attn_num_attention_head, attn_num_key_value_head * n_embd_head_k, attn_num_key_value_head * n_embd_head_v, /*has_bias=*/false, 0);
            ...
            case LLM_ARCH_LFM2MOE:
                {
                    ...
                    for (int i = 0; i < n_layer; ++i) {
                        ...
                        if (!hparams.is_recurrent(i)) {
                            ...
                            create_tensor_qkv(layer, i, n_embd, n_embd, hparams.n_embd_k_gqa(i), hparams.n_embd_v_gqa(i), /*has_bias=*/false, 0);
                    ...
                    for (int i = 0; i < n_layer; ++i) {
                        ...
                        if (hparams.is_recurrent(i)) {
                            ...
                            if (!layer.ssm_q_conv) {
                             ...
                             create_tensor_qkv(layer, i, n_embd, n_embd_head_k_kda * n_head, n_embd_head_k_kda * n_head, n_embd_head_v_kda * n_head, /*has_bias=*/false, 0);
            ...
            case LLM_ARCH_QWEN3NEXT:
                {
                    ...
                    for (int i = 0; i < n_layer; ++i) {
                        ...
                        if (!hparams.is_recurrent(i)) {
                            // Attention layers
                            create_tensor_qkv(layer, i, n_embd, n_embd_head_k * n_head * 2, n_embd_k_gqa, n_embd_v_gqa, /*has_bias=*/false, 0);
                            layer.wo = create_tensor(tn(LLM_TENSOR_ATTN_OUT, "weight", i), { n_embd_head_k * n_head, n_embd }, 0);
            ...
            case LLM_ARCH_STEP35:
                {
                    ...
                    for (int i = 0; i < n_layer; ++i) {
                        ...
                        create_tensor_qkv(layer, i, n_embd, n_embd_head_k * n_head_l, n_embd_k_gqa, n_embd_v_gqa, /*has_bias=*/false, 0);
